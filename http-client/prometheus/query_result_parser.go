...
func ParseQueryResult(metricKey MetricKey, isPrimaryUnit bool, responseBytes []byte, isRange bool) (interface{}, float64) {
	...
	case
		...
		CustomQuotaLimitMemory, CustomQuotaRequestCpu, CustomQuotaRequestMemory, NodeCpu, NodeCpuLoadAverage,
		...
		QuotaLimitPodCpu, QuotaLimitPodEphemeralStorage, QuotaLimitPodMemory, QuotaRequestCpuHard, QuotaRequestCpuUsed,
